...
describe('bootstrapWorkspace', () => {
    ...
    it('throws when plane credentials are invalid', async () => {
        ...
        await expect(bootstrapWorkspace({ planeUrl: 'http://plane', apiToken: 'bad', workspaceSlug: 'ws', webhookUrl: 'http://hook', redis: null })).rejects.toThrow('401');
    });
    it('registers webhook on success', async () => {
        ...
        const result = await bootstrapWorkspace({
            ...
            webhookUrl: 'http://hook', redis: null,
        });
